...
<body>
    ...
    <?php
        ...
        $valor_frete_aux = $usuario_possui_cartao_loja && $valor_compra >= 400 ? 0 : 50;
    ...
    <p> Possui cartão da loja? <?= $usuario_possui_cartao_loja ? 'SiM' : 'NÂO'; ?> </p>

    <p>Valor da compra <?= $valor_compra ?> </p>

    <p> Recebeu desconto no frete ? <?=$recebeu_desconto_frete ? 'SIM' : 'NÂO';?> </p>

    <p>Valor do frete <?= $valor_frete ?> </p>

    <p>Valor total da compra <?= ($valor_compra + $valor_frete)?></p>
</body>
</html>